...
function calculTotalCart() {
    ...
    document.querySelectorAll('#cart .cart_product').forEach(function (tr_cart_product) {
        total += parseInt(tr_cart_product.querySelector('.total_price').dataset.totalPrice);
    })
...
function calculTotalCartProduct(tr_cart_product) {
    ...
    let price_unit = parseInt(tr_cart_product.querySelector('.price_unit').dataset.price);
